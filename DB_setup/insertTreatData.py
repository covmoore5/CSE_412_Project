...
cur.execute("CREATE TABLE Treats (drugId text, indicationId text NOT NULL, PRIMARY KEY (drugId, indicationId), FOREIGN KEY (drugId) REFERENCES Drugs, FOREIGN KEY (indicationId) REFERENCES Indications);")
